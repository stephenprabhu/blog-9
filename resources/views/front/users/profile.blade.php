    ...
    <div class="row">
        <div class="col-4">
            ...
            <div class="mt-3 mb-5">
                ...
                <a href="{{route('password.confirm')}}" class="contact-form__submit">Reset Password</a>
                <a  href="{{route('password.confirm',array('delete_account'=>true))}}"  class="contact-form__submit mt-2">Delete My Account</a>
            </div>
        </div>
        <div class="col-8">
            <h2>Your Comments  </h2>
            ...
            @if (Auth::user()->status)
                ...
                @endforelse
            @else
                    <p>Your account has been blocked. Hence you will not be able to post comments.</p>
            @endif
